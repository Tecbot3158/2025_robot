...
public final class Constants {
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(19.24804); // FIXME Measure and set front left steer offset, 19.73
    ...
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(169.01367); // FIXME Measure and set front right steer offset, 169.36
    ...
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(147.39257); // FIXME Measure and set back left steer offset, 143.61
    ...
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(103.35937); // FIXME Measure and set back right steer offset, 102.92
}
